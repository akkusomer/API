...
namespace AtlasWeb.Migrations
{
    ...
    [Migration("20260402121512_AddTenantScopedHksCities")]
    partial class AddTenantScopedHksCities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AtlasWeb.Models.HksIl", b =>
                {
                    ...
                    b.HasIndex("MusteriId", "HksIlId")
                        .IsUnique()
                        .HasDatabaseName("IX_HksIller_MusteriId_HksIlId_Unique");

                    b.HasIndex("MusteriId", "AktifMi", "KayitTarihi")
                        .HasDatabaseName("IX_HksIl_SaaS_Performance");
